...
export function Hero() {
  ...
  return (
    <section id="home" className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 overflow-hidden min-h-[90vh] flex items-center bg-[#001b3a]">
      {/* Background Gradient & Pattern */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#001b3a] to-white opacity-100 z-0"></div>
      <div className="absolute inset-0 z-0 opacity-10" style={{ backgroundImage: "linear-gradient(#00d4ff 1px, transparent 1px), linear-gradient(90deg, #00d4ff 1px, transparent 1px)", backgroundSize: "40px 40px" }}></div>
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <motion.div 
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 text-primary-foreground text-sm font-medium border border-primary/30 backdrop-blur-sm">
            <MapPin className="w-3 h-3 text-primary-foreground" />
            {t("hero.serving")}
          </div>

          <div className="relative group">
            <div className="absolute -inset-1 bg-primary/20 blur-2xl rounded-full opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              ...
              className="h-14 px-8 text-base rounded-2xl border-2 hover:bg-green-50 hover:text-green-600 hover:border-green-200 transition-all backdrop-blur-sm bg-white/50"
            >
